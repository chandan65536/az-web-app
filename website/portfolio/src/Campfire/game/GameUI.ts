...
//import helpTmpl from '../templates/helpModal.hbs';
//import levelComplete from '../templates/levelCompleteModal.hbs';
//import levelNav from '../templates/gameLevelNav.hbs';
import { GameConstants } from './GameEngine';
import { UserGameState } from './UserGameState';
import { CONSTANTS } from '../constants';

//const helpTmpl = require("../templates/helpModal.hbs");
//const levelComplete = require("../templates/levelCompleteModal.hbs");
//const levelNav = require("../templates/gameLevelNav.hbs");
...
export class GameUI {
    ...
    constructor(
        ...
        this._tmplHelp = Handlebars.compile(CONSTANTS.helpTemplate);
        this._tmplLevelComplete = Handlebars.compile(CONSTANTS.levelCompletelTemplate);
        this._tmplLevelNav = Handlebars.compile(CONSTANTS.levelNavTemplate);
